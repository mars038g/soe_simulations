...
```{r sd of trend estimates, fig.align = "center", echo = F, fig.cap = "Interaction plots of trend estimate standard deviations across autocorrelation strengths ($\\rho = 0, 0.433, 0.8$), trend strengths ($\\alpha_{1} = 0, 0.026, 0.052, 0.147$), and trend methods.\\label{Fig6}"}
stdev <- NULL
